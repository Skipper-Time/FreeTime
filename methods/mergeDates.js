const getFreeTime = (startDate, busySlots) => {
  ...
  function reverseDayIntervals(intervalArr) {
    ...
    let startTime = currentDate.setHours(1, 0, 0, 0);
    startTime = new Date(startTime).toISOString();
    let endTime = currentDate.setHours(14, 0, 0, 0)
...
var startDate = new Date("2022-06-25T00:00:00Z")
